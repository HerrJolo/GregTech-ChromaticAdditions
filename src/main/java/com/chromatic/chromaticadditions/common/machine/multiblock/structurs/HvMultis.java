...
public class HvMultis {
    ...
    public static final MultiblockMachineDefinition PRECISION_ASSEMBLER = HERRJOLO_REGISTRATE
            ...
            .langValue("§6Precision Assembler")
            .tooltips(Component.literal("§7Assembles large Objects and small ones with a high tier of Precision"))
